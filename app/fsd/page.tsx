    ...
    <>
      <section className="py-24 md:py-20 lg:py-28">
        ...
        <div className="container">
          ...
          <article
            data-aos="fade-up"
            className="flex flex-col gap-3 rounded-lg bg-primary bg-opacity-5 p-2  lg:mt-[100px]"
          >
            <h1>Welcome to the Full Stack Development Course!</h1>
            <p>
              In this comprehensive program, you will gain proficiency in
              various programming languages and web development frameworks to
              become a skilled full stack developer. Let's explore the course
              syllabus:
            </p>

            <h2> 👉 Course Overview:</h2>
            <p>
              This course is designed to provide you with a solid foundation in
              full stack development, covering both frontend and backend
              technologies. Throughout the program, you will work on hands-on
              projects to reinforce your understanding and practical skills.
            </p>
            ...
            <ul>
              ...
              <li>
                Styling web pages with CSS and creating engaging user interfaces
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                Manipulating the DOM, handling events, and creating dynamic web
                content
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                Building web applications using Python frameworks such as Flask
                or Django
              </li>
              <li>
                Working with databases using SQL and ORM (Object-Relational
                Mapping)
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                Building robust and scalable backend systems with Java
            ...
            <ul>
              ...
              <li>
                Building interactive and reusable user interfaces with React
                components
              </li>
            ...
            <ul>
              <li>
                Exploring the Angular framework for building dynamic web
                applications
              </li>
            ...
            <ul>
              ...
              <li>
                Building dynamic web applications with PHP frameworks like
                Laravel
              </li>
            ...
            <ul>
              ...
              <li>
                Deploying applications to cloud platforms like Heroku or AWS
              </li>
              <li>Testing and debugging web applications</li>
            </ul>

            <p>
              Throughout the course, you will also learn best practices for
              security, performance optimization, and responsive web design.
            </p>

            <p>
              By the end of this full stack development course, you will have a
              strong foundation in various programming languages, frameworks,
              and tools, enabling you to build end-to-end web applications. You
              will be well-equipped to pursue a career as a full stack developer
              or continue your learning journey in specialized areas of web
              development.
            </p>

            <p>
              Join us now and embark on an exciting journey to becoming a
